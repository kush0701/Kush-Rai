...
class UserOperations:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'C:\Users\Kush\Desktop\__20__final_project.py\orderHistory.json','r') as file:
    ...
    def updateProfile(self):
        ...
        with open(r'C:\Users\KUsh\Desktop\__20__final_project.py\details.json', 'r') as file:
        ...
        for credit in credentials:
            if credit['name']==self.name:
                ...
                with open(r'C:\Users\Kush\Desktop\__20__final_project.py\details.json','w') as w:
...
if __name__ == "__main__":
    user_operations = UserOperations("Kush")
